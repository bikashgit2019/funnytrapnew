    ...
    public function add_page_template( $template )
    {
        ...
        if ( $this->is_account_page( $wp ) )
        {
            ...
            if ( ! empty( $query_vars[0] ) )
            {
                ...
                wp_safe_redirect( esc_url( home_url( '/' . $this->endpoint['account']['slug'] . '/' . $this->endpoint['edit_account']['slug'] ) ) );
            }
    ...
    protected function edit_account_handler()
    {
        ...
        try {
            ...
            wp_update_user(array(
                ...
                'display_name'  => sanitize_text_field( $_POST['fname'] ) . ' ' . sanitize_text_field( $_POST['lname'] ),
