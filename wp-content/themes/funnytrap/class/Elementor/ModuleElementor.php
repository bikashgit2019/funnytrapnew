...
Class ModuleElementor
{
    ...
    public function frontend_script()
    {
    	...
    	wp_enqueue_script( 'jnews-hero', $asset_url . 'js/hero.js', array( 'jquery' ), $this->themeversion, null );
    	wp_enqueue_script( 'jnews-newsticker', $asset_url . 'js/jquery.jnewsticker.js', array( 'jquery' ), $this->themeversion, null ); 
    	wp_enqueue_script( 'jnews-overlayslider', $asset_url . 'js/jquery.joverlayslider.js', array( 'jquery' ), $this->themeversion, null );
    	wp_enqueue_script( 'jnews-videoplaylist', $asset_url . 'js/jquery.jvidplaylist.js', array( 'jquery', 'jscrollpane' ), $this->themeversion, null );
	    wp_enqueue_script( 'jnews-elementor-frontend', $asset_url . 'js/admin/elementor-frontend.js', array( 'jquery' ), $this->themeversion, null );

		wp_enqueue_style( 'jnews-newsticker', $asset_url . 'css/jnewsticker.css', null, $this->themeversion );
		wp_enqueue_style( 'jnews-overlayslider', $asset_url . 'css/joverlayslider.css', null, $this->themeversion );
		wp_enqueue_style( 'jnews-videoplaylist', $asset_url . 'css/jvidplaylist.css', null, $this->themeversion );
    }

    public function editor_style()
    {
        wp_enqueue_style( 'jnews-admin',            get_parent_theme_file_uri( '/assets/css/admin/admin-style.css' ), null, $this->themeversion );
        wp_enqueue_style( 'selectize',              get_parent_theme_file_uri( '/assets/css/admin/selectize.default.css' ), null, $this->themeversion );
    ...
    public function editor_script()
    {
        ...
        wp_enqueue_script( 'selectize',                 get_parent_theme_file_uri( '/assets/js/vendor/selectize.js' ), array( 'jquery' ), $this->themeversion, null );
        wp_enqueue_script( 'jnews-elementor-widget-js', get_parent_theme_file_uri( '/assets/js/admin/widget.js' ), null, $this->themeversion, true );
