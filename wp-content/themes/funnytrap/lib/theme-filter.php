...
function jnews_logout_url() {
	...
	$args['redirect_to'] = esc_url( home_url( '/' ) );
...
if ( ! function_exists( 'jnews_set_elementor_stretched_section_container' ) ) {
	add_action( 'after_setup_theme', 'jnews_set_elementor_stretched_section_container' );
	/**
	 * Set Elementor stretched section parent
	 */
	function jnews_set_elementor_stretched_section_container() {
