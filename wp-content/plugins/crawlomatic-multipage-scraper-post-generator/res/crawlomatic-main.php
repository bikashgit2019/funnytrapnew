      ...
      <form id="myForm" method="post" action="<?php if(is_multisite() && is_network_admin()){echo '../options.php';}else{echo 'options.php';}?>">
         ...
         <div>
                  ...
                  <tr>
                     <td>
                        <h1>
                           ...
                           <span class="cr_07_font">v1.6&nbsp;</span>
            ...
            <div><?php if($crawlomatic_enabled != 'on'){echo '<div class="crf_bord cr_color_red cr_auto_update">' . esc_html__('This feature of the plugin is disabled! Please enable it from the above switch.', 'crawlomatic-multipage-scraper-post-generator') . '</div>';}?>
                  ...
                  <tr>
                     <td colspan="2">
                        ...
                        <?php
                           ...
                           {
                           ?>
                        <div class="notice notice-error is-dismissible"><p><?php echo esc_html__("Automatic updates for this plugin are disabled. Please activate the plugin from below, so you can benefit of automatic updates for it!", 'crawlomatic-multipage-scraper-post-generator');?></p></div>
                     </td>
                  </tr>
                  <tr>
                     <td>
               ...
               <h3>
                  <ul>
                     <li><?php echo sprintf( wp_kses( __( 'Need help configuring this plugin? Please check out it\'s <a href="%s" target="_blank">video tutorial</a>.', 'crawlomatic-multipage-scraper-post-generator'), array(  'a' => array( 'href' => array(), 'target' => array() ) ) ), esc_url( 'https://www.youtube.com/watch?v=7BYDa72zY7c&list=PLEiGTaa0iBIgcqNzVBaoTCS4ws47vNMuQ' ) );?>
                     </li>
                  ...
                  <tr>
                     <td colspan="2">
                        <h3><?php echo esc_html__("Translation Options:", 'crawlomatic-multipage-scraper-post-generator');?></h3>
                     </td>
                  </tr>
                  <tr>
                    <td>
                 ...
                 <tr>
                  ...
                  <tr>
                     <td colspan="2">
                        <h3><?php echo esc_html__("Plugin Options:", 'crawlomatic-multipage-scraper-post-generator');?></h3>
                     </td>
                  </tr>
                  <tr>
                     <td>
                  ...
                  <tr>
                     <td>
                        <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                           <div class="bws_hidden_help_text cr_min_260px">
                              <?php
                                 echo esc_html__("Check this to force the plugin to not crawl content that is disallowed for crawling by a robots meta tag. Meta tag values that will stop crawling are noindex, nofollow and none.", 'crawlomatic-multipage-scraper-post-generator');
                                 ?>
                           </div>
                        </div>
                        <b><?php echo esc_html__("Respect Robots HTML Header For Crawled Pages:", 'crawlomatic-multipage-scraper-post-generator');?></b>
                     </td>
                     <td>
                     ...
                     <td>
                        <div>
                           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                              <div class="bws_hidden_help_text cr_min_260px">
                                 <?php
                                    echo esc_html__("If you want to use a proxy to crawl webpages, input it's address here. Required format: IP Address/URL:port. You can input a comma separated list of proxies.", 'crawlomatic-multipage-scraper-post-generator');
                                    ?>
                              </div>
                           </div>
                     ...
                     <td>
                        <div>
                           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                              <div class="bws_hidden_help_text cr_min_260px">
                                 <?php
                                    echo esc_html__("Set the timeout (in milliseconds) between each subsequest call to the crawled website. Increase this value if the website has a anti-crawling mechanism active. Here you can also input a pair of values, separrated by comma (ex: 300,500). In this case, a random timeout will be selected, between the two values you specified.", 'crawlomatic-multipage-scraper-post-generator');
                                    ?>
                              </div>
                           </div>
                           <b><?php echo esc_html__("Delay Between Request (milliseconds):", 'crawlomatic-multipage-scraper-post-generator');?></b>
                        </div>
                     </td>
                     <td>
                        <div>
                           <input type="number" min="0" step="1" id="request_delay" placeholder="<?php echo esc_html__("Input request delay", 'crawlomatic-multipage-scraper-post-generator');?>" name="crawlomatic_Main_Settings[request_delay]" value="<?php echo esc_html($request_delay);?>"/>
                        </div>
                     </td>
                  </tr>
                  <tr>
                 ...
                 <tr>
                  ...
                  <tr>
                     ...
                     <option value="wikisynonyms"
                        <?php
                           ...
                           ?>
                        >WikiSynonyms - <?php echo esc_html__("Low Quality - Free", 'crawlomatic-multipage-scraper-post-generator');?></option>
                     <option value="freethesaurus"
                        <?php
                           ...
                           ?>
                        >FreeThesaurus - <?php echo esc_html__("Low Quality - Free", 'crawlomatic-multipage-scraper-post-generator');?></option>
                     </select>
                     </div>
                     </td>
                  </tr>
                  ...
                  <tr>
                     <td colspan="2">
                        <h3><?php echo esc_html__("PhantomJS Settings:", 'crawlomatic-multipage-scraper-post-generator');?></h3>
                     </td>
                  </tr>
                  <tr>
                     <td>
                     ...
                     <td>
                        <div>
                           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                              <div class="bws_hidden_help_text cr_min_260px">
                                 <?php
                                    echo esc_html__("Set the timeout (in milliseconds) for every phantomjs running. I recommend that you leave this field at it's default value (15000). If you leave this field blank, the default value will be used.", 'crawlomatic-multipage-scraper-post-generator');
                                    ?>
                              </div>
                           </div>
                           <b><?php echo esc_html__("Timeout for PhantomJs Execution:", 'crawlomatic-multipage-scraper-post-generator');?></b>
                        </div>
                     </td>
                     <td>
                        <div>
                           <input type="number" id="phantom_timeout" step="1" min="1" placeholder="<?php echo esc_html__("Input phantomjs timeout in milliseconds", 'crawlomatic-multipage-scraper-post-generator');?>" name="crawlomatic_Main_Settings[phantom_timeout]" value="<?php echo esc_html($phantom_timeout);?>"/>
                        </div>
                     </td>
                  </tr>
                  <tr>
...
<p>
   <?php echo esc_html__("Available shortcodes:", 'crawlomatic-multipage-scraper-post-generator');?> <strong>[crawlomatic-list-posts]</strong> <?php echo esc_html__("to include a list that contains only posts imported by this plugin, and", 'crawlomatic-multipage-scraper-post-generator');?> <strong>[crawlomatic-display-posts]</strong> <?php echo esc_html__("to include a WordPress like post listing. Usage:", 'crawlomatic-multipage-scraper-post-generator');?> [crawlomatic-display-posts type='any/post/page/...' title_color='#ffffff' excerpt_color='#ffffff' read_more_text="Read More" link_to_source='yes' order='ASC/DESC' orderby='title/ID/author/name/date/rand/comment_count' title_font_size='19px', excerpt_font_size='19px' posts_per_page=number_of_posts_to_show category='posts_category' ruleid='ID_of_crawlomatic_rule'].
   ...
   <br/><?php echo esc_html__("Example 2:", 'crawlomatic-multipage-scraper-post-generator');?> <b>[crawlomatic-display-posts include_excerpt='true' image_size='thumbnail' wrapper='div']</b>. <?php echo esc_html__("Please check plugin's documentation for more info.", 'crawlomatic-multipage-scraper-post-generator');?>
</p>
</div>
<?php
   }
