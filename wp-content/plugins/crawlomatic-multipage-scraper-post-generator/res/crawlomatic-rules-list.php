...
<div>
   <form id="myForm" method="post" action="<?php echo (crawlomatic_isSecure() ? "https" : "http") . "://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]";?>">
      <?php
         wp_nonce_field( 'crawlomatic_save_rules', '_echor_nonce' );
               ...
               <table id="mainRules" class="responsive table cr_main_table">
                  <thead>
                     <tr>
                        ...
                        <th>
                           <?php echo esc_html__("Post Status", 'crawlomatic-multipage-scraper-post-generator');?>
                           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                              <div class="bws_hidden_help_text cr_min_260px">
                                 <?php
                        ...
                        <th>
                           <?php echo esc_html__("Item Type", 'crawlomatic-multipage-scraper-post-generator');?>
                           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                              <div class="bws_hidden_help_text cr_min_260px">
                                 <?php
                        ...
                        <th>
                           <?php echo esc_html__("Post Author", 'crawlomatic-multipage-scraper-post-generator');?>
                           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                              <div class="bws_hidden_help_text cr_min_260px">
                                 <?php
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td class="cr_select_option"><input type="url" validator="url" name="crawlomatic_rules_list[textids][]" id="crawlomatic_crawl_start" placeholder="Please input the seed URL" value="" class="cr_width_full"/></td>
                        <td class="cr_comm_td"><input type="number" step="1" min="1" name="crawlomatic_rules_list[schedule][]" class="cr_width_60" placeholder="Select the rule schedule interval" value="24"/></td>
                        ...
                        <td class="cr_status">
                           <select id="submit_status" name="crawlomatic_rules_list[submit_status][]" class="cr_width_70">
                              <option value="pending"><?php echo esc_html__("Pending -> Moderate", 'crawlomatic-multipage-scraper-post-generator');?></option>
                              <option value="draft"><?php echo esc_html__("Draft -> Moderate", 'crawlomatic-multipage-scraper-post-generator');?></option>
                              <option value="publish" selected><?php echo esc_html__("Published", 'crawlomatic-multipage-scraper-post-generator');?></option>
                              <option value="private"><?php echo esc_html__("Private", 'crawlomatic-multipage-scraper-post-generator');?></option>
                              <option value="trash"><?php echo esc_html__("Trash", 'crawlomatic-multipage-scraper-post-generator');?></option>
                           </select>
                        </td>
                        <td class="cr_comm_td"><select id="default_type" name="crawlomatic_rules_list[default_type][]" class="cr_width_auto">
                           <?php
                              $is_first = true;
                        ...
                        <td class="cr_author"><select id="post_author" name="crawlomatic_rules_list[post_author][]" class="cr_width_auto cr_max_width_150">
                            <option value="rnd-crawlomatic"><?php echo esc_html__("Random user", 'crawlomatic-multipage-scraper-post-generator');?></option>
                            <option value="feed-crawlomatic"><?php echo esc_html__("Import crawled author", 'crawlomatic-multipage-scraper-post-generator');?></option>
                           <?php
                                       ...
                                       <table class="responsive cr_main_table_nowr">
                                             ...
                                             <td class="cr_min_240">
                                                <div>
                                                   <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                                      <div class="bws_hidden_help_text cr_min_260px">
                                                         <?php
                                                            echo esc_html__("Set the title of the generated posts for user rules. You can use the following shortcodes: %%random_sentence%%, %%random_sentence2%%, %%item_title%%, %%item_description%%, %%item_content%%, %%item_cat%%, %%item_tags%%. You will also be able to use the custom shortcodes defined in the 'Custom Shortcode Creator' feature from below.", 'crawlomatic-multipage-scraper-post-generator');
                                                            ?>
                                                      </div>
                                                   </div>
                                             ...
                                             <td>
                                                <div>
                                                   <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                                      <div class="bws_hidden_help_text cr_min_260px">
                                                         <?php
                                                            echo esc_html__("Set the content of the generated posts for user rules. You can use the following shortcodes: %%custom_html%%, %%custom_html2%%, %%random_sentence%%, %%random_sentence2%%, %%item_title%%, %%item_original_price%%, %%item_price%%, %%item_content%%, %%royalty_free_image_attribution%%, %%item_url%%, %%item_cat%%, %%item_tags%%, %%item_content_plain_text%%, %%item_screenshot_url%%, %%item_show_screenshot%%, %%item_read_more_button%%, %%item_show_image%%, %%item_image_URL%%, %%item_description%%, %%item_pub_date%%. If you wish to embed YouTube or Vimeo videos, you should use the following format: [embed]%%item_url%%[/embed]. You will also be able to use the custom shortcodes defined in the 'Custom Shortcode Creator' feature from below.", 'crawlomatic-multipage-scraper-post-generator');
                                                            ?>
                                                      </div>
                                                   </div>
                                             ...
                                             <td>
                                                <div>
                                                   <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                                      <div class="bws_hidden_help_text cr_min_260px">
                                                         <?php
                                                            echo esc_html__("Run regex on post content. To disable this feature, leave this field blank. No Regex separators are required here.", 'crawlomatic-multipage-scraper-post-generator');
                                                            ?>
                                                      </div>
                                                   </div>
                                             ...
                                             <td>
                                                <div>
                                                   <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                                      <div class="bws_hidden_help_text cr_min_260px">
                                                         <?php
                                                            echo esc_html__("Replace the above regex matches with this regex expression. If you want to strip matched content, leave this field blank. No Regex separators are required here.", 'crawlomatic-multipage-scraper-post-generator');
                                                            ?>
                                                      </div>
                                                   </div>
                                             ...
                                             <td>
                                                <div>
                                                   <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                                      <div class="bws_hidden_help_text cr_min_260px">
                                                         <?php
                                                            echo esc_html__("Run regex on post title. To disable this feature, leave this field blank. No Regex separators are required here.", 'crawlomatic-multipage-scraper-post-generator');
                                                            ?>
                                                      </div>
                                                   </div>
                                             ...
                                             <td>
                                                <div>
                                                   <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                                      <div class="bws_hidden_help_text cr_min_260px">
                                                         <?php
                                                            echo esc_html__("Strip HTML elements from final content that match this XPATH. To disable this feature, leave this field blank.", 'crawlomatic-multipage-scraper-post-generator');
                                                            ?>
                                                      </div>
                                                   </div>
                                                   <b><?php echo esc_html__("Strip HTML Elements by XPATH:", 'crawlomatic-multipage-scraper-post-generator');?></b>
                                             </td>
                                             <td>
                                          ...
                                          <tr>
                                             <td>
                                                <div>
                                                   ...
                                                   <b><?php echo esc_html__("Limit Article Word Count:", 'crawlomatic-multipage-scraper-post-generator');?></b>
                                                </div>
                                             </td>
                                             <td>
                                                <div>
                                                   <input type="number" id="limit_word_count" step="1" placeholder="Input the maximum word count for generated articles" class="cr_width_full" min="0" name="crawlomatic_rules_list[limit_word_count][]" value=""/>
                                                </div>
                                             </td>
                                          </tr>
                                          <tr>
                                             <td>
                                                <div>
                                                   <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                                      <div class="bws_hidden_help_text cr_min_260px"><?php echo esc_html__("Do you want to automatically translate generated content using Google Translate?", 'crawlomatic-multipage-scraper-post-generator');?>
                                                      </div>
                                                   </div>
                                             ...
                                             <td class="cr_min_width_200">
                                                <div>
                                                   <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                                      <div class="bws_hidden_help_text cr_min_260px">
                                                         <?php
                                                            echo esc_html__("Select the user agent value you want to send with each request. If crawling fails for a webpage, you can try to set here a custom value. Example of Google Chrome user agent: Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36 - You can also set this to 'random' and the plugin will generate a random User Agent each time it runs.", 'crawlomatic-multipage-scraper-post-generator');
                                                            ?>
                                                      </div>
                                                   </div>
                                          ...
                                          <tr>
                                             <td>
                                                <div>
                                                   ...
                                                   <b><?php echo esc_html__("Maximum Crawl Results to Get:", 'crawlomatic-multipage-scraper-post-generator');?></b>
                                                </div>
                                             </td>
                                             <td>
                                                <div>
                                          ...
                                          <tr>
                                             <td>
                                                <div>
                                                   <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                                      <div class="bws_hidden_help_text cr_min_260px"><?php echo esc_html__("Do you want to try to use PhantomJS to try to parse JavaScript from crawled pages (for pages that create dynamic content, on page load, using JavaScript)? Please note that for this to work, you must have PhantomJs installed on your server. You can configure the path to PhantomJS from your server, from plugin's 'Main Settings'.", 'crawlomatic-multipage-scraper-post-generator');?>
                                                      </div>
                                                   </div>
                                                   <b><?php echo esc_html__("Use PhantomJs/Puppeteer To Parse JavaScript On Pages:", 'crawlomatic-multipage-scraper-post-generator');?></b>
                                                </div>
                                             </td>
                                             <td>
                                                <div>
                                                   <select id="use_phantom" name="crawlomatic_rules_list[use_phantom][]" class="cr_width_full">
                                                    <option value="0" selected><?php echo esc_html__("Disabled", 'crawlomatic-multipage-scraper-post-generator');?></option>
                                                    <option value="1"><?php echo esc_html__("Use PhantomJS", 'crawlomatic-multipage-scraper-post-generator');?></option>          
                                                    <option value="2"><?php echo esc_html__("Use Puppeteer", 'crawlomatic-multipage-scraper-post-generator');?></option>
                                                   </select>               
                                                </div>
                                             </td>
                                          </tr>
                                          <tr>
                                             <td>
                                                <div>
                                                   ...
                                                   <b><?php echo esc_html__("Phantomjs Wait Before Rendering Pages (ms):", 'crawlomatic-multipage-scraper-post-generator');?></b>
                                                </div>
                                             </td>
                                             <td>
                                                <div>
                                          ...
                                          <tr>
                                             <td>
                                                <div>
                                                   ...
                                                   <b><?php echo esc_html__("Do Not Scrape Start URL:", 'crawlomatic-multipage-scraper-post-generator');?></b>
                                                </div>
                                             </td>
                                             <td>
                                                <div>
                                             ...
                                             <td>
                                                <div>
                                                   <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                                      <div class="bws_hidden_help_text cr_min_260px">
                                                         <?php
                                                            echo sprintf( wp_kses( __( "Select the query type you want to crawl source page from. XPath: <a href='%s' target='_blank'>More info/tutorial</a>.", 'crawlomatic-multipage-scraper-post-generator'), array(  'a' => array( 'href' => array(), 'target' => array() ) ) ), esc_url( 'https://www.w3schools.com/xml/xpath_intro.asp' ) );
                                                            ?>
                                                      </div>
                                                   </div>
                                             ...
                                             <td>
                                                <div>
                                                   <select id="seed_type" name="crawlomatic_rules_list[seed_type][]" class="crawlomatic_selector cr_width_full" data-source-field-id="crawlomatic_crawl_start" data-target-field-id="seed_expre" data-target-field-cont="">
                                                      ...
                                                      <option value="xpath"><?php echo esc_html__("XPath", 'crawlomatic-multipage-scraper-post-generator');?></option>
                                          ...
                                          <tr>
                                             ...
                                             <td>
                                                <div>
                                                   <input type="text" id="seed_expre" name="crawlomatic_rules_list[seed_expre][]" value="" placeholder="Please insert your query" class="cr_width_full">
                                                </div>
                                             </td>
                                          </tr>
                                          <tr>
                                             ...
                                             <td>
                                                <div>
                                                   <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                                      <div class="bws_hidden_help_text cr_min_260px">
                                                         <?php
                                                            echo sprintf( wp_kses( __( "Select the query type you want to crawl already crawled pages from. XPath: <a href='%s' target='_blank'>More info/tutorial</a>.", 'crawlomatic-multipage-scraper-post-generator'), array(  'a' => array( 'href' => array(), 'target' => array() ) ) ), esc_url( 'https://www.w3schools.com/xml/xpath_intro.asp' ) );
                                                            ?>
                                                      </div>
                                                   </div>
                                          ...
                                          <tr>
                                             <td>
                                                <div>
                                                   ...
                                                   <b><?php echo esc_html__("URLs to Not Crawl and Import:", 'crawlomatic-multipage-scraper-post-generator');?></b>
                                                </div>
                                             </td>
                                             <td>
                                                <div>
                                          ...
                                          <tr>
                                             <td>
                                                <div>
                                                   ...
                                                   <b><?php echo esc_html__("Post Titles to Not Crawl and Import:", 'crawlomatic-multipage-scraper-post-generator');?></b>
                                                </div>
                                             </td>
                                             <td>
                                                <div>
                                             ...
                                             <td>
                                                <div>
                                                   <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                                      <div class="bws_hidden_help_text cr_min_260px">
                                                         <?php
                                                            echo sprintf( wp_kses( __( "Select the query type you want to search for the article full content. XPath: <a href='%s' target='_blank'>More info/tutorial</a>.", 'crawlomatic-multipage-scraper-post-generator'), array(  'a' => array( 'href' => array(), 'target' => array() ) ) ), esc_url( 'https://www.w3schools.com/xml/xpath_intro.asp' ) );
                                                            ?>
                                                      </div>
                                                   </div>
                                          ...
                                          <tr>
                                             ...
                                             <td>
                                                <div>
                                                   <input type="text" id="expre" name="crawlomatic_rules_list[expre][]" value="" placeholder="Please insert your query" class="cr_width_full">
                                                </div>
                                             </td>
                                          </tr>
                                          <tr>
                                             ...
                                             <td>
                                                <div>
                                                   <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                                      <div class="bws_hidden_help_text cr_min_260px">
                                                         <?php
                                                            echo esc_html__("Input the query string of the html element where the post pagination links will be found. These links will be crawled and content will be concatenated into one single generated post.", 'crawlomatic-multipage-scraper-post-generator');
                                                            ?>
                                                      </div>
                                                   </div>
                                          ...
                                          <tr>
                                             <td>
                                                <div>
                                                   <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                                      <div class="bws_hidden_help_text cr_min_260px"><?php echo esc_html__("Select the query type you want to search for the article title. XPath:", 'crawlomatic-multipage-scraper-post-generator');?> <a href='https://www.w3schools.com/xml/xpath_intro.asp' target='_blank'><?php echo esc_html__("More info/tutorial", 'crawlomatic-multipage-scraper-post-generator');?></a>.
                                                      </div>
                                                   </div>
                                          ...
                                          <tr>
                                             <td>
                                                <div>
                                                   <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                                      <div class="bws_hidden_help_text cr_min_260px">
                                                         <?php
                                                            echo sprintf( wp_kses( __( "Input the search query for title searching. This can be the ID or class name you want to search, the <a href='%s' target='_blank'>regex expression</a> you want to apply for or the XPath Expression you want to query for. <a href='%s' target='_blank'>More info/tutorial</a>. If you leave this field blank, the title will be automatically detected for you.", 'crawlomatic-multipage-scraper-post-generator'), array(  'a' => array( 'href' => array(), 'target' => array() ) ) ), esc_url( 'https://regexone.com/' ), esc_url( 'https://www.w3schools.com/xml/xpath_intro.asp' ) );
                                                            ?>
                                                      </div>
                                                   </div>
                                             ...
                                             <td>
                                                <div>
                                                   <input type="text" id="title_expre" name="crawlomatic_rules_list[title_expre][]" value="" placeholder="Please insert your query" class="cr_width_full">
                                                </div>
                                             </td>
                                          </tr>
                                          <tr>
                                             <td>
                                                <div>
                                                   <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                                      <div class="bws_hidden_help_text cr_min_260px"><?php echo esc_html__("Select the query type you want to search for the article author. XPath:", 'crawlomatic-multipage-scraper-post-generator');?> <a href='https://www.w3schools.com/xml/xpath_intro.asp' target='_blank'><?php echo esc_html__("More info/tutorial", 'crawlomatic-multipage-scraper-post-generator');?></a>.
                                                      </div>
                                                   </div>
                                             ...
                                             <td>
                                                <div>
                                                   <select id="type" name="crawlomatic_rules_list[author_type][]" class="crawlomatic_selector cr_width_full" data-child-type-field-id="seed_type" data-child-expression-field-id="seed_expre" data-source-field-id="crawlomatic_crawl_start" data-target-field-id="author_expre" data-target-field-cont="">
                                                      <option value="disabled" selected><?php echo esc_html__("Disabled", 'crawlomatic-multipage-scraper-post-generator');?></option>
                                                      <option value="visual"><?php echo esc_html__("Visual Selector", 'crawlomatic-multipage-scraper-post-generator');?></option>
                                                      <option value="og"><?php echo esc_html__("Meta:Author", 'crawlomatic-multipage-scraper-post-generator');?></option>
                                                      <option value="id"><?php echo esc_html__("ID", 'crawlomatic-multipage-scraper-post-generator');?></option>
                                                      <option value="class"><?php echo esc_html__("Class", 'crawlomatic-multipage-scraper-post-generator');?></option>
                                                      <option value="xpath"><?php echo esc_html__("XPath", 'crawlomatic-multipage-scraper-post-generator');?></option>
                                                      <option value="regex"><?php echo esc_html__("Regex - First Match", 'crawlomatic-multipage-scraper-post-generator');?></option>
                                          ...
                                          <tr>
                                             ...
                                             <td>
                                                <div>
                                                   <input type="text" id="author_expre" name="crawlomatic_rules_list[author_expre][]" value="" placeholder="Please insert your query" class="cr_width_full">
                                                </div>
                                             </td>
                                          </tr>
                                          <tr>
                                             <td>
                                                <div>
                                                   <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                                      <div class="bws_hidden_help_text cr_min_260px"><?php echo esc_html__("Select the query type you want to search for the article image. XPath:", 'crawlomatic-multipage-scraper-post-generator');?> <a href='https://www.w3schools.com/xml/xpath_intro.asp' target='_blank'><?php echo esc_html__("More info/tutorial", 'crawlomatic-multipage-scraper-post-generator');?></a>.
                                                      </div>
                                                   </div>
                                             ...
                                             <td>
                                                <div>
                                                   <select id="type" name="crawlomatic_rules_list[image_type][]" class="crawlomatic_selector cr_width_full" data-child-type-field-id="seed_type" data-child-expression-field-id="seed_expre" data-source-field-id="crawlomatic_crawl_start" data-target-field-id="image_expre" data-target-field-cont="">
                                                      ...
                                                      <option value="auto" selected><?php echo esc_html__("Auto Detect", 'crawlomatic-multipage-scraper-post-generator');?></option>
                                                      <option value="visual"><?php echo esc_html__("Visual Selector", 'crawlomatic-multipage-scraper-post-generator');?></option>
                                                      <option value="og"><?php echo esc_html__("OG:Image", 'crawlomatic-multipage-scraper-post-generator');?></option>
                                                      <option value="id"><?php echo esc_html__("ID", 'crawlomatic-multipage-scraper-post-generator');?></option>
                                                      <option value="class"><?php echo esc_html__("Class", 'crawlomatic-multipage-scraper-post-generator');?></option>
                                                      <option value="xpath"><?php echo esc_html__("XPath", 'crawlomatic-multipage-scraper-post-generator');?></option>
                                                      <option value="regex"><?php echo esc_html__("Regex - First Match", 'crawlomatic-multipage-scraper-post-generator');?></option>
                                          ...
                                          <tr>
                                             <td>
                                                <div>
                                                   <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                                      <div class="bws_hidden_help_text cr_min_260px">
                                                         <?php
                                                            echo sprintf( wp_kses( __( "Select the query type you want to search for the article category. XPath: <a href='%s' target='_blank'>More info/tutorial</a>.", 'crawlomatic-multipage-scraper-post-generator'), array(  'a' => array( 'href' => array(), 'target' => array() ) ) ), esc_url( 'https://www.w3schools.com/xml/xpath_intro.asp' ) );
                                                            ?>
                                                      </div>
                                                   </div>
                                             ...
                                             <td>
                                                <div>
                                                   <select id="type" name="crawlomatic_rules_list[cat_type][]" class="crawlomatic_selector cr_width_full" data-child-type-field-id="seed_type" data-child-expression-field-id="seed_expre" data-source-field-id="crawlomatic_crawl_start" data-target-field-id="tag_expre" data-target-field-cont="">
                                                      <option value="disabled" selected><?php echo esc_html__("Disabled", 'crawlomatic-multipage-scraper-post-generator');?></option>
                                                      <option value="visual"><?php echo esc_html__("Visual Selector", 'crawlomatic-multipage-scraper-post-generator');?></option>
                                                      <option value="id"><?php echo esc_html__("ID", 'crawlomatic-multipage-scraper-post-generator');?></option>
                                                      <option value="class"><?php echo esc_html__("Class", 'crawlomatic-multipage-scraper-post-generator');?></option>
                                          ...
                                          <tr>
                                             <td>
                                                <div>
                                                   <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                                      <div class="bws_hidden_help_text cr_min_260px">
                                                         <?php
                                                            echo sprintf( wp_kses( __( "Input the search query for category searching. This can be the ID or class name you want to search, the <a href='%s' target='_blank'>regex expression</a> you want to apply for or the XPath Expression you want to query for. <a href='%s' target='_blank'>More info/tutorial</a>. If you leave this field blank, no categories will be automatically detected for you.", 'crawlomatic-multipage-scraper-post-generator'), array(  'a' => array( 'href' => array(), 'target' => array() ) ) ), esc_url( 'https://regexone.com/' ), esc_url( 'https://www.w3schools.com/xml/xpath_intro.asp') );
                                                            ?>
                                                      </div>
                                                   </div>
                                             ...
                                             <td>
                                                <div>
                                                   <input type="text" id="cat_expre" name="crawlomatic_rules_list[cat_expre][]" value="" placeholder="Please insert your query" class="cr_width_full">
                                                </div>
                                             </td>
                                          </tr>
                                          <tr>
                                             ...
                                             <td>
                                                <div>
                                                   <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                                      <div class="bws_hidden_help_text cr_min_260px">
                                                         <?php
                                                            echo sprintf( wp_kses( __( "Select the query type you want to search for the article tags. XPath: <a href='%s' target='_blank'>More info/tutorial</a>.", 'crawlomatic-multipage-scraper-post-generator'), array(  'a' => array( 'href' => array(), 'target' => array() ) ) ), esc_url( 'https://www.w3schools.com/xml/xpath_intro.asp' ) );
                                                            ?>
                                                      </div>
                                                   </div>
                                          ...
                                          <tr>
                                             ...
                                             <td>
                                                <div>
                                                   <input type="text" id="tag_expre" name="crawlomatic_rules_list[tag_expre][]" value="" placeholder="Please insert your query" class="cr_width_full">
                                                </div>
                                             </td>
                                          </tr>
                                          <tr>
                                             ...
                                             <td>
                                                <div>
                                                   <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                                      <div class="bws_hidden_help_text cr_min_260px">
                                                         <?php
                                                            echo sprintf( wp_kses( __( "Select the query type you want to search for the product price. XPath: <a href='%s' target='_blank'>More info/tutorial</a>. The price will be automatically added to the product if you are importing it to WooCommerce. Also, the price will be available in the %%item_price%% shortcode. You can modify the price from the 'Price Related Options' in plugin's 'Main Settings'. In this case, old price will be available in the %%item_old_price%% shortcode and the new price will be added to the %%item_price%% shortcode.", 'crawlomatic-multipage-scraper-post-generator'), array(  'a' => array( 'href' => array(), 'target' => array() ) ) ), esc_url( 'https://www.w3schools.com/xml/xpath_intro.asp' ));
                                                            ?>
                                                      </div>
                                                   </div>
                                          ...
                                          <tr>
                                             <td>
                                                <div>
                                                   <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                                      <div class="bws_hidden_help_text cr_min_260px"><?php echo esc_html__("Do you want to strip commas from product prices? This will help if you have prices with commas that are not decimal separators.", 'crawlomatic-multipage-scraper-post-generator');?>
                                                      </div>
                                                   </div>
                                                   <b><?php echo esc_html__("Strip Comma From Product Prices:", 'crawlomatic-multipage-scraper-post-generator');?></b>
                                                </div>
                                             </td>
                                             <td>
                                                <div>
                                                   <input type="checkbox" id="strip_comma" name="crawlomatic_rules_list[strip_comma][]">               
                                                </div>
                                             </td>
                                          </tr>
                                       </table>
   ...
   if (isset($_POST['crawlomatic_rules_list'])) {
   	add_action('admin_init', 'crawlomatic_save_rules_manual');
           ...
           function crawlomatic_save_rules_manual($data2) {
               ...
               check_admin_referer( 'crawlomatic_save_rules', '_echor_nonce' );
               ...
               if(isset($data2['textids'][0]))
               {
                   for($i = 0; $i < sizeof($data2['textids']); ++$i) {
                       ...
                       if(isset($data2['schedule'][$i]) && $data2['schedule'][$i] != '' && $data2['textids'][$i] != '')
                       {
                           ...
                           $bundle[] = trim( sanitize_text_field( $data2['strip_comma'][$i] ) );
   			...
   			if (!empty($rules)) {
   				...
   				foreach ($rules as $request => $bundle[]) {
   					...
   					$output .= '<tr>
   						...
   						<td class="cr_select_option"><input type="url" placeholder="The field URL is required" validator="url" name="crawlomatic_rules_list[textids][]" id="crawlomatic_crawl_start' . esc_html($cont) . '" value="'.esc_attr($textids).'" required></td>
   						<td class="cr_comm_td"><input type="number" step="1" min="1" placeholder="# h" name="crawlomatic_rules_list[schedule][]" class="cr_width_60" value="'.esc_attr($schedule).'" required></td>
                           ...
                           <td class="cr_status"><select id="submit_status" name="crawlomatic_rules_list[submit_status][]" class="cr_width_70">
                                     <option value="pending"';
                       if($status == 'pending')
                       {
                           $output .= ' selected';
                       }
                       $output .= '>' . esc_html__("Pending -> Moderate", 'crawlomatic-multipage-scraper-post-generator') . '</option>
                                     <option value="draft"';
                       if($status == 'draft')
                       {
                           $output .= ' selected';
                       }
                       $output .= '>' . esc_html__("Draft -> Moderate", 'crawlomatic-multipage-scraper-post-generator') . '</option>
                                     <option value="publish"';
                       if($status == 'publish')
                       {
                           $output .= ' selected';
                       }
                       $output .= '>' . esc_html__("Published", 'crawlomatic-multipage-scraper-post-generator') . '</option>
                                     <option value="private"';
                       if($status == 'private')
                       {
                           $output .= ' selected';
                       }
                       $output .= '>' . esc_html__("Private", 'crawlomatic-multipage-scraper-post-generator') . '</option>
                                     <option value="trash"';
                       if($status == 'trash')
                       {
                           $output .= ' selected';
                       }
                       $output .= '>' . esc_html__("Trash", 'crawlomatic-multipage-scraper-post-generator') . '</option>
                       </select>  </td>
                       <td class="cr_comm_td"><select id="default_type" name="crawlomatic_rules_list[default_type][]" class="cr_width_auto">';
               foreach ( get_post_types( '', 'names' ) as $post_type ) {
                  ...
                  $output .= '>' . esc_html($post_type) . '</option>';
                       ...
                       $output .=  '>' . esc_html__('Import crawled author', 'crawlomatic-multipage-scraper-post-generator') . '</option>';
       $blogusers = get_users( [ 'role__in' => [ 'contributor', 'author', 'editor', 'administrator' ] ] );
       foreach ($blogusers as $user) {
     ...
     <div class="codemodalfzr-content">
       ...
       <div>
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
               ...
               foreach ($all_categories as $cat) {
                       if($cat->category_parent == 0) {
                           $category_id = $cat->term_id;
                           $output .= '<option value="w' . esc_url($cat->term_id) . '"';
                           foreach($default_category as $dc)
                           {
                               if ('w' . $cat->term_id == $dc) {
                                   $output .= ' selected';
                           ...
                           $output .= '>' . 'WooCommerce: ' . sanitize_text_field($cat->name) . ' - ID ' . esc_html($cat->term_id) . '</option>';
                           $args2 = array(
                                   'taxonomy'     => $taxonomy,
                                   'child_of'     => 0,
                                   'parent'       => $category_id,
                           ...
                           if($sub_cats) {
                               foreach($sub_cats as $sub_category) {
                                   $output .= '<option value="w' . esc_url($sub_category->term_id) . '"';
                                   foreach($default_category as $dc)
                                   {
                                   ...
                                   $output .= '>    WooCommerce: ' . sanitize_text_field($sub_category->name) . ' - ID ' . esc_html($sub_category->term_id) . '</option>';
                               }   
                           }
                       }       
               }
           ...
           </td></tr><tr><td colspan="2"><h3>' . esc_html__("Featured Image Options:", 'crawlomatic-multipage-scraper-post-generator') . '</h3>
           </td></tr><tr><td>
           <div>
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
           ...
           </td></tr><tr><td colspan="2"><h3>' . esc_html__("Posting Restrictions:", 'crawlomatic-multipage-scraper-post-generator') . '</h3>
           </td></tr><tr><td>
           <div>
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
           ...
           <div>
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                           <div class="bws_hidden_help_text cr_min_260px">' . esc_html__("Run regex on post content. To disable this feature, leave this field blank. No Regex separators are required here.", 'crawlomatic-multipage-scraper-post-generator') . '
                           </div>
                       </div>
           ...
           <div>
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                           <div class="bws_hidden_help_text cr_min_260px">' . esc_html__("Replace the above regex matches with this regex expression. If you want to strip matched content, leave this field blank. No Regex separators are required here.", 'crawlomatic-multipage-scraper-post-generator') . '
                           </div>
                       </div>
           ...
           <div>
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                           <div class="bws_hidden_help_text cr_min_260px">' . esc_html__("Run regex on post title. To disable this feature, leave this field blank. No Regex separators are required here.", 'crawlomatic-multipage-scraper-post-generator') . '
                           </div>
                       </div>
           ...
           <div>
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                           <div class="bws_hidden_help_text cr_min_260px">' . esc_html__("Strip HTML elements from final content that match this XPATH. To disable this feature, leave this field blank.", 'crawlomatic-multipage-scraper-post-generator') . '
                           </div>
                       </div>
                       <b>' . esc_html__("Strip HTML Elements by XPATH", 'crawlomatic-multipage-scraper-post-generator') . ':</b>
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <b>' . esc_html__("Limit Article Word Count", 'crawlomatic-multipage-scraper-post-generator') . ':</b>
                       </div>
                       </td><td>
                       <div>
                       <input type="number" id="limit_word_count" step="1" class="cr_width_full" placeholder="Input the maximum word count for generated articles" min="0" name="crawlomatic_rules_list[limit_word_count][]" value="' . esc_attr($limit_word_count) . '"/>
           </div>
           </td></tr><tr><td>
           <div>
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                           <div class="bws_hidden_help_text cr_min_260px">' . esc_html__("Do you want to automatically translate generated content using Google Translate?", 'crawlomatic-multipage-scraper-post-generator') . '
                           </div>
                       </div>
       ...
       if(isset($crawlomatic_Main_Settings['deepl_auth']) && $crawlomatic_Main_Settings['deepl_auth'] != '')
       {
           ...
           foreach ($language_names_deepl as $lang) {
               $output .= '<option value="' . esc_attr($language_codes_deepl[$i]) . '"';
               if ($source_language == $language_codes_deepl[$i]) {
                   $output .= ' selected';
               }
               $output .= '>' . esc_html($language_names_deepl[$i]) . '</option>';
               $i++;
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <b>' . esc_html__("Maximum Crawl Results to Get", 'crawlomatic-multipage-scraper-post-generator') . ':</b>
                       </div>
                       </td><td>
                       <div>
   	...
   	foreach($GLOBALS['encodings'] as $enc){
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <b>' . esc_html__("Use PhantomJs/Puppeteer To Parse JavaScript On Pages", 'crawlomatic-multipage-scraper-post-generator') . ':</b>';
                       if($use_phantom == '1')
                       {
                           if($phantom === false)
                           {
                           ...
                           elseif($phantom === -1)
                           {
                               $output .= '<br/><span class="cr_red12"><b>' . esc_html__('INFO: PhantomJS cannot run - shell_exec is not enabled on your server. Please enable it and retry using this feature of the plugin.', 'crawlomatic-multipage-scraper-post-generator') . '</b></span>';
                           }
                           elseif($phantom === -2)
                           {
                               $output .= '<br/><span class="cr_red12"><b>' . esc_html__('INFO: PhantomJS cannot run - shell_exec is not allowed to run on your server (in disable_functions list in php.ini). Please enable it and retry using this feature of the plugin.', 'crawlomatic-multipage-scraper-post-generator') . '</b></span>';
                           }
                           elseif($phantom === 1)
                           {
           ...
           $output .= '>' . esc_html__("Use PhantomJS", 'crawlomatic-multipage-scraper-post-generator') . '</option>          
                        <option value="2"';
           if ($use_phantom == '2') {
               $output .= ' selected';
           }
           $output .= '>' . esc_html__("Use Puppeteer", 'crawlomatic-multipage-scraper-post-generator') . '</option>
                       </select>            
           </div>
           </td></tr><tr><td>
           <div>
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <b>' . esc_html__("Phantomjs Wait Before Rendering Pages (ms)", 'crawlomatic-multipage-scraper-post-generator') . ':</b>
                       </div>
                       </td><td>
                       <div>
                       <input type="number" min="0" step="1" id="phantom_wait" name="crawlomatic_rules_list[phantom_wait][]" value="' . esc_attr($phantom_wait) . '" placeholder="0" class="cr_width_full">                   
           </div>
           </td></tr><tr><td>
           <div>
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <b>' . esc_html__("Do Not Scrape Start URL", 'crawlomatic-multipage-scraper-post-generator') . ':</b>
                       </div>
                       </td><td>
                       <div>
                       <input type="checkbox" id="no_source" name="crawlomatic_rules_list[no_source][]"';
           ...
           <div>
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                           <div class="bws_hidden_help_text cr_min_260px">' . sprintf( wp_kses( __( 'Select the query type you want to crawl source page from. XPath: <a href=\'%s\' target=\'_blank\'>More info/tutorial</a>.', 'crawlomatic-multipage-scraper-post-generator'), array(  'a' => array( 'href' => array(), 'target' => array() ) ) ), esc_url( 'https://www.w3schools.com/xml/xpath_intro.asp' ) ) . '
                           </div>
                       </div>
                       ...
                       $output .= '>' . esc_html__("XPath", 'crawlomatic-multipage-scraper-post-generator') . '</option>
                       <option value="regex"';
                       if($seed_type == 'regex')
                       {
                           $output .= ' selected';
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <div>
                       <input type="text" id="seed_expre' . esc_html($cont) . '" name="crawlomatic_rules_list[seed_expre][]" value="' . htmlspecialchars($seed_expre) . '" placeholder="Please insert your query" class="cr_width_full">
           ...
           <div>
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                           <div class="bws_hidden_help_text cr_min_260px">' . sprintf( wp_kses( __( 'Select the query type you want to crawl already crawled pages from. XPath: <a href=\'%s\' target=\'_blank\'>More info/tutorial</a>.', 'crawlomatic-multipage-scraper-post-generator'), array(  'a' => array( 'href' => array(), 'target' => array() ) ) ), esc_url( 'https://www.w3schools.com/xml/xpath_intro.asp' ) ) . '
                           </div>
                       </div>
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <b>' . esc_html__("URLs to Not Crawl and Import", 'crawlomatic-multipage-scraper-post-generator') . ':</b>
                       </div>
                       </td><td>
                       <div>
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <b>' . esc_html__("Post Titles to Not Crawl and Import", 'crawlomatic-multipage-scraper-post-generator') . ':</b>
                       </div>
                       </td><td>
                       <div>
           ...
           </td></tr><tr><td colspan="2"><h3>' . esc_html__('Content Scraping Customizations:', 'crawlomatic-multipage-scraper-post-generator') . '</h3></td></tr><tr><td>
           <div>
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                           <div class="bws_hidden_help_text cr_min_260px">' . sprintf( wp_kses( __( 'Select the query type you want to search for the article full content. XPath: <a href="%s" target="_blank">More info/tutorial</a>.', 'crawlomatic-multipage-scraper-post-generator'), array(  'a' => array( 'href' => array(), 'target' => array() ) ) ), esc_url( 'https://www.w3schools.com/xml/xpath_intro.asp' ) ) . '
                           </div>
                       </div>
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <div>
                       <input type="text" id="expre' . esc_html($cont) . '" name="crawlomatic_rules_list[expre][]" value="' . htmlspecialchars($expre) . '" placeholder="Please insert your query" class="cr_width_full">
           ...
           <div>
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                           <div class="bws_hidden_help_text cr_min_260px">' . esc_html__("Input the query type of the html element where the post pagination links will be found. These links will be crawled and content will be concatenated into one single generated post.", 'crawlomatic-multipage-scraper-post-generator') . '
                           </div>
                       </div>
           ...
           <div>
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                           <div class="bws_hidden_help_text cr_min_260px">' . sprintf( wp_kses( __( 'Select the query type you want to search for the article title. XPath: <a href=\'%s\' target=\'_blank\'>More info/tutorial</a>.', 'crawlomatic-multipage-scraper-post-generator'), array(  'a' => array( 'href' => array(), 'target' => array() ) ) ), esc_url( 'https://www.w3schools.com/xml/xpath_intro.asp' ) ) . '
                           </div>
                       </div>
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <div>
                       <input type="text" id="title_expre' . esc_html($cont) . '" name="crawlomatic_rules_list[title_expre][]" value="' . htmlspecialchars($title_expre) . '" placeholder="Please insert your query" class="cr_width_full">
                           
           </div>
           </td></tr><tr><td>
           <div>
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                           <div class="bws_hidden_help_text cr_min_260px">' . sprintf( wp_kses( __( 'Select the query type you want to search for the article author. XPath: <a href=\'%s\' target=\'_blank\'>More info/tutorial</a>.', 'crawlomatic-multipage-scraper-post-generator'), array(  'a' => array( 'href' => array(), 'target' => array() ) ) ), esc_url( 'https://www.w3schools.com/xml/xpath_intro.asp' ) ) . '
                           </div>
                       </div>
                       ...
                       $output .= '>' . esc_html__("Meta:Author", 'crawlomatic-multipage-scraper-post-generator') . '</option>
                       <option value="id"';
                       if($author_type == 'id')
                       {
                           $output .= ' selected';
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <div>
                       <input type="text" id="author_expre' . esc_html($cont) . '" name="crawlomatic_rules_list[author_expre][]" value="' . htmlspecialchars($author_expre) . '" placeholder="Please insert your query" class="cr_width_full">
                           
           </div>
           </td></tr><tr><td>
           <div>
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                           <div class="bws_hidden_help_text cr_min_260px">' . sprintf( wp_kses( __( 'Select the query type you want to search for the article image. XPath: <a href="%s" target="_blank">More info/tutorial</a>.', 'crawlomatic-multipage-scraper-post-generator'), array(  'a' => array( 'href' => array(), 'target' => array() ) ) ), esc_url( 'https://www.w3schools.com/xml/xpath_intro.asp' ) ) . '
                           </div>
                       </div>
                       ...
                       $output .= '>' . esc_html__("OG:Image", 'crawlomatic-multipage-scraper-post-generator') . '</option>
                       <option value="id"';
                       if($image_type == 'id')
                       {
                           $output .= ' selected';
           ...
           <div>
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                           <div class="bws_hidden_help_text cr_min_260px">' . sprintf( wp_kses( __( 'Select the query type you want to search for the article category. XPath: <a href="%s" target="_blank">More info/tutorial</a>.', 'crawlomatic-multipage-scraper-post-generator'), array(  'a' => array( 'href' => array(), 'target' => array() ) ) ), esc_url( 'https://www.w3schools.com/xml/xpath_intro.asp' ) ) . '
                           </div>
                       </div>
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <div>
                       <input type="text" id="cat_expre' . esc_html($cont) . '" name="crawlomatic_rules_list[cat_expre][]" value="' . htmlspecialchars($cat_expre) . '" placeholder="Please insert your query" class="cr_width_full">
           ...
           <div>
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                           <div class="bws_hidden_help_text cr_min_260px">' . sprintf( wp_kses( __( 'Select the query type you want to search for the article tags. XPath: <a href="%s" target="_blank">More info/tutorial</a>.', 'crawlomatic-multipage-scraper-post-generator'), array(  'a' => array( 'href' => array(), 'target' => array() ) ) ), esc_url( 'https://www.w3schools.com/xml/xpath_intro.asp' ) ) . '
                           </div>
                       </div>
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <div>
                       <input type="text" id="tag_expre' . esc_html($cont) . '" name="crawlomatic_rules_list[tag_expre][]" value="' . htmlspecialchars($tag_expre) . '" placeholder="Please insert your query" class="cr_width_full">
           ...
           <div>
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                           <div class="bws_hidden_help_text cr_min_260px">' . sprintf( wp_kses( __( 'Select the query type you want to search for the product price. XPath: <a href=\'%s\' target=\'_blank\'>More info/tutorial</a>.  The price will be automatically added to the product if you are importing it to WooCommerce. Also, the price will be available in the %%item_price%% shortcode.  You can modify the price from the \'Price Related Options\' in plugin\'s \'Main Settings\'. In this case, old price will be available in the %%item_old_price%% shortcode and the new price will be added to the %%item_price%% shortcode.', 'crawlomatic-multipage-scraper-post-generator'), array(  'a' => array( 'href' => array(), 'target' => array() ) ) ), esc_url( 'https://www.w3schools.com/xml/xpath_intro.asp' ) ) . '
                           </div>
                       </div>
           ...
           <div>
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                           <div class="bws_hidden_help_text cr_min_260px">' . esc_html__("Do you want to strip commas from product prices? This will help if you have prices with commas that are not decimal separators.", 'crawlomatic-multipage-scraper-post-generator') . '
                           </div>
                       </div>
                       <b>' . esc_html__("Strip Comma From Product Prices", 'crawlomatic-multipage-scraper-post-generator') . ':</b>
                       </div>
                       </td><td>
                       <div>
                       <input type="checkbox" id="strip_comma" name="crawlomatic_rules_list[strip_comma][]"';
       ...
       <div class="codemodalfzr-footer">
         ...
         <br/><br/>
                           ...
                           if (isset($crawlomatic_Main_Settings['no_check']) && $crawlomatic_Main_Settings['no_check'] == 'on')
                           {
                               $output .= '<div class="bws_hidden_help_text cr_min_260px">' . sprintf( wp_kses( __( 'Shortcode for this rule<br/>(to cross-post from this plugin in other plugins):', 'crawlomatic-multipage-scraper-post-generator'), array(  'br' => array( ) ) ) ) . '<br/><b>%%crawlomatic_0_' . esc_html($cont) . '%%</b><br/>' . esc_html__('Posts Generated:', 'crawlomatic-multipage-scraper-post-generator') . ' ' . esc_html__('post count checking disabled from plugin settings', 'crawlomatic-multipage-scraper-post-generator') . '<br/>';
                           }
                           else
                           {
                               $output .= '<div class="bws_hidden_help_text cr_min_260px">' . sprintf( wp_kses( __( 'Shortcode for this rule<br/>(to cross-post from this plugin in other plugins):', 'crawlomatic-multipage-scraper-post-generator'), array(  'br' => array( ) ) ) ) . '<br/><b>%%crawlomatic_0_' . esc_html($cont) . '%%</b><br/>' . esc_html__('Posts Generated:', 'crawlomatic-multipage-scraper-post-generator') . ' ' . esc_html($generated_posts) . '<br/>';
                           }
