...
registerBlockType( 'youtubomatic-youtube-post-generator/youtubomatic-grid-channel', {
    title: 'Youtubomatic Grid Channel Embed',
    icon: 'video-alt2',
    category: 'embed',
    attributes: {
        id : {
    ...
    edit: (function( props ) {
		...
		return gcel(
            ...
            gcel(
                ...
                'Youtubomatic Channel Grid Embed ',
                gcel(
                    'div', 
                    ...
                    gcel(
                        ...
                        'This block is used to embed YouTube channels in a grid.'
                    )
                )
			),
            gcel(
            ...
            gcel(
                ...
                gcel(
                    'div', 
                    {className:'bws_hidden_help_text'},
                    'Input the YouTube channel ID you wish to embed in the post.'
                )
            ),
            gcel(
				'input',
				{ type:'text',placeholder:'YouTube channel ID', value: id, onChange: updateMessage, className: 'coderevolution_gutenberg_input' }
			),
            gcel(
				'br'
			),
