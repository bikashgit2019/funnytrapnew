...
else
{
    ...
    jQuery("#bestspin").hide();
        ...
        if (jQuery("#oauth_key").val().length > 0 && jQuery("#oauth_secret").val().length > 0) 
        {
            jQuery(".hideInfo2").hide();
        }
        if(jQuery('#links_hide').is(":checked") || jQuery('#links_hide_google2').is(":checked"))
        {            
            jQuery(".hideGoo").show();
        }
        else
    ...
    jQuery(document).ready(function(){
					jQuery('span.wpyoutubomatic-delete').on('click', function(){
