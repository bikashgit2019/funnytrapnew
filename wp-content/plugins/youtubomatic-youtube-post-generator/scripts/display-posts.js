...
registerBlockType( 'youtubomatic-youtube-post-generator/youtubomatic-display', {
    title: 'Youtubomatic Display Posts',
    icon: 'video-alt2',
    category: 'embed',
    attributes: {
        ruletype : {
    ...
    keywords: ['display', 'posts', 'youtubomatic'],
    edit: (function( props ) {
