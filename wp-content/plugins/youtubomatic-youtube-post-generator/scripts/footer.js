                    ...
                    window.onbeforeunload = unloadPage;
                        ...
                        function runNowManual(number)
                        {
                            if (confirm("Are you sure you want to run this rule now?") == true) {
                                ...
                                document.getElementById("run_img" + number).src= mycustomsettings.plugin_dir_url + "images/running.gif";
                                var data = {
                                    action: 'youtubomatic_run_my_action',
                                    id: number
                                };
                                jQuery.post(ajaxurl, data, function(response) {
                                    if(response.trim() == 'ok')
...
function actionsChangedManual(ruleId, selectedValue)
{
    ...
    else
    {
		...
		jQuery(document).ready(function() {
			jQuery('.youtubomatic_image_button').on('click', function(){
...
var span = document.getElementById("youtubomatic_close");
var ok = document.getElementById("youtubomatic_ok");
if(btn != null)
{
...
function createAdmin(i) {
    ...
    spans = document.getElementById("youtubomatic_close" + i);
    oks = document.getElementById("youtubomatic_ok" + i);
