...
registerBlockType( 'youtubomatic-youtube-post-generator/youtubomatic-list', {
    title: 'Youtubomatic List Posts',
    icon: 'video-alt2',
    category: 'embed',
    attributes: {
        ruletype : {
    ...
    keywords: ['list', 'posts', 'youtubomatic'],
    edit: (function( props ) {
