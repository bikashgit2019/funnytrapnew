(function($) {
  ...
  $(document).ready(function() {
    ...
    $('#cancel').click(function(event) {
      ...
      window.location.replace(window.daamAdminUrl + 'admin.php?page=daam-categories');
    ...
    $('.menu-icon.delete').click(function(event) {
      event.preventDefault();
      window.DAAM.categoryToDelete = $(this).prev().val();
  ...
  //         $('#form-delete-' + window.DAAM.categoryToDelete).submit();
  //       },
