...
class Daam_Pagination
{
    ...
    function get_pagenum_link($id)
    {
        ...
        //sort: sb, or -------------------------------------------------------------------------------------------------
        $sort = '';
        if (isset($_GET['sb']) and ($_GET['sb'] == 'pi' or $_GET['sb'] == 'cl' or $_GET['sb'] == 'al' or $_GET['sb'] == 'alv')) {
            $sort .= '&sb=' . $_GET['sb'];
        }
        ...
        if (strpos($this->target_page, '?') === false) {
            return esc_url($this->target_page . "?" . $this->parameterName . "=" . $id . $sort . $filter);
        } else {
            return esc_url($this->target_page . "&" . $this->parameterName . "=" . $id . $sort . $filter);
        }
