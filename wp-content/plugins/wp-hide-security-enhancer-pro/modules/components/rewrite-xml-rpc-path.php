            ...
            function get_module_component_settings()
                {
                    ...
                    $this->component_settings[]                  =   array(
                                                                    ...
                                                                    'help'          =>  array(
                                                                                                        ...
                                                                                                        'description'               =>  __("This blocks the default XML-RPC service. The functionality apply if <b>New XML-RPC Path</b> option is filled in or not.",    'wp-hide-security-enhancer') . "<br/><br />" .
